    ...
    <div class="container">
        ...
        <div class="room__slider">
            ...
            <div class="room__controls">
                <button class="slider__btn slider__btn--prev room__btn" type="button" aria-label="Предыдущая комната">
                    <svg class="slider__icon room__icon" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M15.41 16.59L10.83 12l4.58-4.59L14 6l-6 6 6 6 1.41-1.41z"/>
                    </svg>
                </button>
                <div class="slider__dots room__dots"></div>
                <button class="slider__btn slider__btn--next room__btn" type="button" aria-label="Следующая комната">
                    <svg class="slider__icon room__icon" viewBox="0 0 24 24" fill="currentColor">
